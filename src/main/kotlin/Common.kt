...
public inline infix fun Double.prem(x: Double): Double = (rem(x) + x) % x
...
public inline infix fun Int.prem(x: Int): Int = (rem(x) + x) % x
...
public inline fun repeated(x: Double): Double = x prem 1.0
