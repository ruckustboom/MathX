...
public inline infix fun Double.remChunk(x: Double): Double = (rem(x) + x) % x
public inline infix fun Double.divChunk(x: Double): Double = minus(remChunk(x)) / x
...
public inline infix fun Int.remChunk(x: Int): Int = (rem(x) + x) % x
public inline infix fun Int.divChunk(x: Int): Int = minus(remChunk(x)) / x
...
public inline fun repeated(x: Double): Double = x remChunk 1.0
